...
namespace _220208_REVIEW_03_UnityLesson_CSharp_Variable
{
    class Program
    {
    ...
    class Person
    {
        ...
        bool isReseting = false; // 논리형 쉬고있는가? // bool : 1 byte 논리
                                 // **( 참, 거짓은 1bit 로 판별 가능하지만,
                                 // CPU의 데이터 처리 최소단위가 1 Byte 이므로
                                 // 그 이하 단위 처리는 불가능하다)

        char genderChar = 'M';   // 문자형 성별 문자 // char : 2 byte 문자
